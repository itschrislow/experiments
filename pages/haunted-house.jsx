...
const Door = () => {
  const [
    ...
    "/static/textures/haunted-house/door/color.jpg",
    "/static/textures/haunted-house/door/alpha.jpg",
    "/static/textures/haunted-house/door/ambientOcclusion.jpg",
    "/static/textures/haunted-house/door/height.jpg",
    "/static/textures/haunted-house/door/normal.jpg",
    "/static/textures/haunted-house/door/roughness.jpg",
    "/static/textures/haunted-house/door/metalness.jpg",
  ]);

  return (
    <mesh position={[0, 2 / 2, 4 / 2 + 0.01]}>
  ...
  return (
    <mesh
      ...
      geometry={({ getAttribute }) => [
        "uv2",
        new THREE.Float32BufferAttribute(getAttribute("uv").array, 2),
      ]}
    >
